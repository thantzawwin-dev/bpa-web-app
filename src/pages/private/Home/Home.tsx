...
const Home = (props: Props) => {
  return (
    <div>
      ...
      <img src={Game} className="theme-category-logo" alt="loading" />

      <img src={GamePNG} className="theme-category-logo" alt="loading" />

      <img src={GameJPG} className="theme-category-logo" alt="loading" />
