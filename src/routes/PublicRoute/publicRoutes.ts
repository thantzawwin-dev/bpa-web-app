...
export const publicRoutes: Array<RouteProps> = [
  ...
  { key: 2, props: { path: '/400' }, element: Page400 },
  { key: 3, props: { path: '/401' }, element: Page401 },
  { key: 4, props: { path: '/404' }, element: Page404 },
  { key: 5, props: { path: '/500' }, element: Page500 },
  { key: 6, props: { path: '/Error' }, element: Error },
  {
    key: 0,
    props: { path: '/*' },
    element: Navigate,
